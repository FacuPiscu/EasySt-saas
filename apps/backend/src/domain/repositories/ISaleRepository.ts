...
export interface ISaleRepository {
    ...
    getDailySalesAggregated(tenantId: string, startDate: Date, endDate: Date): Promise<{ totalAmount: number; breakdown: { method: string; amount: number }[]; cashiers: { name: string; amount: number }[] }>;
